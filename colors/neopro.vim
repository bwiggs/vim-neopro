...
if has("gui_running")
    ...
    hi IncSearch      gui=BOLD   guifg=#ffffff   guibg=#000000
    hi Search         gui=NONE   guifg=#ffffff   guibg=#000000
    hi ErrorMsg       gui=BOLD   guifg=#FE0058   guibg=#3C1616
    hi WarningMsg     gui=BOLD   guifg=#FF9907   guibg=#000000
    ...
    hi User2          gui=BOLD   guifg=#ffffff   guibg=#000000
    ...
    hi DiffText       gui=NONE   guifg=#ffffff   guibg=#000000
    hi DiffChange     gui=NONE   guifg=#ffffff   guibg=#000000
    hi DiffDelete     gui=NONE   guifg=#ffffff   guibg=#000000
    hi DiffAdd        gui=NONE   guifg=#ffffff   guibg=#000000
    ...
    hi Folded         gui=NONE   guifg=#ffffff   guibg=#000000
    hi FoldColumn     gui=NONE   guifg=#ffffff   guibg=#000000
    ...
    hi Boolean        gui=NONE   guifg=#0094FF   guibg=#000000
    hi Comment        gui=NONE   guifg=#555555   guibg=#000000
    ...
    hi SpecialChar    gui=NONE   guifg=#ffffff   guibg=#000000
    ...
    hi perlSpecialMatch   gui=NONE guifg=#ffffff   guibg=#000000
    hi perlSpecialString  gui=NONE guifg=#ffffff   guibg=#000000

    hi javaScriptLabel          gui=NONE   guifg=#9FFD39   guibg=#33570F

    hi cSpecialCharacter  gui=NONE guifg=#ffffff   guibg=#000000
    hi cFormat            gui=NONE guifg=#ffffff   guibg=#000000
